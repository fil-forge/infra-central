...
// belong in SSM immediately; neither is returned to the stack.
...
// initialised.
//
// The wait exists because the platform stack invokes this Lambda as soon as the
// ECS service is created, which is well before the task is serving. With KMS seal
